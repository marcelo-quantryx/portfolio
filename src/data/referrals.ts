...
export const referrals: Referral[] = [
  {
    ...
    testimonial: "I collaborated with Marcelo on the Liberty Music PR project, where he demonstrated exceptional skills in developing web scraping solutions and API integrations.",
